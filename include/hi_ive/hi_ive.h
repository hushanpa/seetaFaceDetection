...
*Modify template filter from 3x3 to 5x5 ,2013-07-11
*/
...
*Add IVE_SOBEL_OUT_CTRL_E ,2013-07-11
*/
...
/*
*Type of the Integ output results, created , 2013-03-18
* Modify, 2013-07-15
...
/*
* Integ control parameters,Create in 2013-07-15
*/
...
/*
*Equalizehist control parameters,created, 2013-07-17
*/
...
{ 
	...
	IVE_CCL_MODE_8C  =  0x1,/*4-connected*/
...
typedef struct hiIVE_LK_OPTICAL_FLOW_CTRL_S
{
    ...
    HI_U8	    u8IterCount;        /*Maximum iteration times, <=20*/
